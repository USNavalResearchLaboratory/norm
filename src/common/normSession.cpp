...
#include "protolib/protoPktETH.h"
#include "protolib/protoPktIp.h"
...
{   
    ...
    switch (msg.GetType())
    {
        ...
        case NormMsg::DATA:
        {
            ...
            if (syn_status) objMsg.SetFlag(NormObjectMsg::FLAG_SYN);
            break;
        }
        case NormMsg::CMD:
        {
